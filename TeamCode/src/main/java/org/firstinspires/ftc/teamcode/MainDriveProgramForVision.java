...
import org.firstinspires.ftc.teamcode.yise.tensorFlowClass;

@TeleOp(name="Center Stage Vision", group="Linear Opmode")
public class MainDriveProgramForVision extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // create instance of Vision system class
        tensorFlowClass vision = new tensorFlowClass(hardwareMap, telemetry);
        ...
        while (opModeIsActive()) {
             ...
             * Telemetry data
             */
            telemetry.addData("x of object", vision.x);
            telemetry.addData("y of object", vision.y);
            telemetry.addData("x of image 2/3", vision.imageXTwoThirds);
            telemetry.addData("x of image 1/3", vision.imageXOneThird);
            telemetry.addData("y of image 2/3", vision.imageYTwoThirds);
            telemetry.addData("y of image 1/3", vision.imageYOneThird);
